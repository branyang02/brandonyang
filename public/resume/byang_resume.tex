...
\begin{tabular} {@{}l}
    ...
    \faLink \, \linkhref{https://brandonyifanyang.com/}{brandonyifanyang.com} \quad \faEnvelope \, \linkhref{mailto:yang52@seas.upenn.edu}{yang52@seas.upenn.edu} \quad \faGithub \, \linkhref{https://github.com/branyang02}{branyang02} \quad \faGraduationCap \, \linkhref{https://scholar.google.com/citations?user=dZny9s0AAAAJ&hl=en}{Google Scholar}
\end{tabular}
...
\begin{itemize}[label={}, leftmargin=0pt]
    \item \headingjob{Research Lead}{San Francisco, CA}{AfterQuery}{May 2026 - Present}
          \begin{itemize}
...
\begin{itemize}[label={}, leftmargin=0pt]
    ...
    \item Miranda M.*, Subin K.*, \textbf{Brandon Y. Yang*}, Lyle Ungar, and Dinesh Jayaraman. ``Contrastive Conceptor Activation Steering (COAST): Unlocking Vision-Language-Action Models through Hidden States." Submitted to \textit{NeurIPS 2026}. \hfill [\linkhref{https://github.com/COAST-VLA/COAST}{Github}]
