...
\begin{itemize}[label={}, leftmargin=0pt]
    \item \headingjob{Incoming AI/ML Engineer Intern}{Mountain View, CA}{LinkedIn}{May 2026 - Aug 2026}
          \begin{itemize}
              \item Incoming AI/ML Engineer Intern at LinkedIn.
          \end{itemize}
...
\begin{itemize}[label={}, leftmargin=0pt]
    \item \heading{General Robotics, Automation, Sensing, and Perception Lab, UPenn}{Philadelphia, PA}
          ...
          \begin{itemize}
              \item Designing retrieval-augmented VLA models for robot manipulation (ongoing, target: CoRL 2026).
...
\begin{itemize}[label={}, leftmargin=0pt]
    \item Miranda M.*, Subin K.*, \textbf{Brandon Y. Yang*}, Lyle Ungar, and Dinesh Jayaraman. ``Contrastive Conceptor Activation Steering (COAST): Unlocking Vision-Language-Action Models through Hidden States." \\
          In submission to \textit{NeurIPS 2026}. {\footnotesize *Equal contribution.}
