...
\begin{tabular}{  m{0.5\textwidth}  >{\raggedleft\arraybackslash}m{0.5\textwidth}  }
  \begin{tabular} {@{}l}
    ...
    \faLink \, \linkhref{https://brandonyifanyang.com/}{brandonyifanyang.com} \quad \faEnvelope \, \linkhref{mailto:brandonyang@seas.upenn.edu}{brandonyang@seas.upenn.edu}
  \end{tabular}
   &
  \begin{tabular}{@{}c l@{}}
...
\begin{itemize}
  ...
  \item\heading{%
        ...
        }{Philadelphia, PA}{MSE in Robotics \emph{\&} MSE in Computer and Information Science}{Aug 2025 - Expected 2028}
